      ...
      {isExpanded && (
        <div className="space-y-3 mt-2">
          {readings.map((reading, index) => (
            <div key={reading.readId} className="pl-4 border-l-2 border-gray-200">
              ...
              {index < readings.length - 1 && <div className="h-px bg-gray-100 my-2"></div>}
            </div>
          ))}
        </div>
      )}
